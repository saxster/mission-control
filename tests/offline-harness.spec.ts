...
test.describe('Mission Control fixture harness', () => {
  test('capabilities expose runtime state dir/config in offline test mode', async ({ request }) => {
  ...
  test('sessions API reads fixture sessions without a live gateway install', async ({ request }) => {
