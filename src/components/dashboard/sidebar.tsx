...
const menuItems: MenuItem[] = [
  ...
  { id: 'knowledge-base', label: 'Knowledge Base', icon: '🧠', description: 'Wiki, graph, and structured knowledge' },
  { id: 'obsidian', label: 'Obsidian', icon: '🪨', description: 'Vault sync, conflicts, and import queue' },
